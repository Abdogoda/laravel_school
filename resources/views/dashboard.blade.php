...
<div class="page-title mb-3">
 <div class="row">
  <div class="col-sm-6">
   <h3 class="mb-0"> {{__('trans.dashboard')}}</h3>
   <p class="text-muted">{{__('trans.welcome_dashboard')}}</p>
  </div>
  <div class="col-sm-6">
  ...
  <div class="card card-statistics h-100">
   <div class="card-body">
    ...
    <p class="text-muted pt-3 mb-0 mt-2 border-top">
     <i class="fa fa-binoculars mr-1" aria-hidden="true"></i> <a href="{{route('students.index')}}">{{__('trans.view_details')}}</a>
    </p>
   </div>
  </div>
 </div>
  ...
  <div class="card card-statistics h-100">
   <div class="card-body">
    <div class="clearfix">
     ...
     <div class="float-right text-right">
      <p class="card-text text-dark">{{__('trans.teachers_count')}}</p>
      <h4>{{\App\Models\Teacher::count()}}</h4>
     </div>
    </div>
    <p class="text-muted pt-3 mb-0 mt-2 border-top">
      <i class="fa fa-binoculars mr-1" aria-hidden="true"></i> <a href="{{route('teachers.index')}}">{{__('trans.view_details')}}</a>
    </p>
   </div>
  </div>
 </div>
  ...
  <div class="card card-statistics h-100">
   <div class="card-body">
    <div class="clearfix">
     ...
     <div class="float-right text-right">
      <p class="card-text text-dark">{{__('trans.gardians_count')}}</p>
      <h4>{{\App\Models\Gardian::count()}}</h4>
     </div>
    </div>
    <p class="text-muted pt-3 mb-0 mt-2 border-top">
      <i class="fa fa-binoculars mr-1" aria-hidden="true"></i> <a href="{{route('gardians.index')}}">{{__('trans.view_details')}}</a>
    </p>
   </div>
  </div>
 </div>
 <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
  <div class="card card-statistics h-100">
   <div class="card-body">
    ...
    <p class="text-muted pt-3 mb-0 mt-2 border-top">
      <i class="fa fa-binoculars mr-1" aria-hidden="true"></i> <a href="{{route('sections.index')}}">{{__('trans.view_details')}}</a>
    </p>
   </div>
  </div>
 </div>
        ...
        <div class="card-body">
            <div class="tab nav-border" style="position: relative;">
                <div class="d-flex flex-column flex-md-row flex-wrap align-items-center justify-content-between">
                    ...
                    <div class="d-flex nav-tabs-custom">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="fee_invoices_table-tab" data-toggle="tab" href="#fee_invoices_table" role="tab" aria-controls="fee_invoices_table" aria-selected="false">{{__('trans.invoices')}}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="tab-content" id="myTabContent">
                    ...
                    {{--invoices Table--}}
                    <div class="tab-pane fade" id="fee_invoices_table" role="tabpanel" aria-labelledby="fee_invoices_table-tab">
                        <div class="table-responsive mt-15">
                            <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                <thead>
                                <tr class="table-info">
                                    <th>#</th>
                                    <th>{{__('trans.invoice_type')}}</th>
                                    <th>{{__('trans.student_name')}}</th>
                                    <th>{{__('trans.stage')}}</th>
                                    <th>{{__('trans.class')}}</th>
                                    <th>{{__('trans.cost')}}</th>
                                ...
                                @forelse(\App\Models\FeeInvoice::latest()->take(10)->get() as $invoice)
                                    <tr>
                                        ...
                                        <td><a href="{{route('students.show', $invoice->student_id)}}">{{$invoice->student->name}}</a></td>
