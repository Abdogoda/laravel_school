...
class StoreStudentRequest extends FormRequest{
    ...
    public function rules(): array{
        return [
            ...
            'phone' => 'nullable|min:11|max:11|unique:students,phone',
            'national_id' => 'required|numeric|digits:14|unique:students,national_id',
            'passport_id' => 'nullable|numeric|digits:14|unique:students,passport_id',
