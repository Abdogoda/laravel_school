 ...
 header start-->
        <nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="text-left navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="{{url('/dashboard')}}"><img src="{{URL::asset('assets/images/logo-dark.png')}}" alt="logo"><span class="mx-1 color-green"><b>{{__('trans.our_school')}}</b></span></a> 
            ...
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item dropdown d-flex align-items-center">
                    <button class="btn btn-outline-secondary dropdown-toggle" type="button" id="dropdownLangMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <li class="nav-item dropdown mr-30">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#"><i class="text-secondary ti-reload"></i>{{__('trans.activity')}}</a>
                        <a class="dropdown-item" href="#"><i class="text-success ti-email"></i>{{__('trans.messegs')}}</a>
                        <a class="dropdown-item" href="#"><i class="text-warning ti-user"></i>{{__('trans.profile')}}</a>
                        <a class="dropdown-item" href="#"><i class="text-dark ti-layers-alt"></i>{{__('trans.projects')}} <span
                                class="badge badge-info">6</span> </a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#"><i class="text-info ti-settings"></i>{{__('trans.settings')}}</a>
                        <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="text-danger ti-unlock"></i>{{ __('trans.logout') }}</a>
