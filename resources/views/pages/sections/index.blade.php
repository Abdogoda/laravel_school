    ...
    <div class="col-md-12 mb-30">
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <br><br>
                <div class="accordion dark plus-icon shadow">
                                        ...
                                        <tbody>
                                            @forelse ($stage->sections as $section)
                                                <tr>
                                                    ...
                                                    <td class="d-flex">
                                                        <button type='button' class="btn btn-success btn-sm m-1" data-toggle="modal" data-target="#edit-{{$section->id}}-Modal">{{__('trans.edit')}} <i class="fa fa-edit"></i></button>
                                                        <button type='button' class="btn btn-danger btn-sm m-1" data-toggle="modal" data-target="#delete-{{$section->id}}-Modal">{{__('trans.delete')}} <i class="fa fa-trash"></i></button>
                                                    </td>
                                                </tr>
