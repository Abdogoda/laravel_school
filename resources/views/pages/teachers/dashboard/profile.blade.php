                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted mb-4">{{__('teacher')}}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                        ...
                        <div class="card-body">
                            <form action="{{route('teacher_profile.update')}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <p class="text-muted mb-0">
                                            <input type="text" name="name_ar" value="{{ $teacher->getTranslation('name', 'ar') }}" class="form-control border">
                                        </p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <p class="text-muted mb-0">
                                            <input type="text" name="name_en" value="{{ $teacher->getTranslation('name', 'en') }}" class="form-control border">
                                        </p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <p class="text-muted mb-0">
                                            <input type="email" name="email" value="{{ $teacher->email }}" class="form-control border">
                                        </p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <p class="text-muted mb-0">
                                            <input type="text" minlength="11" maxlength="11" name="phone" value="{{ $teacher->phone }}" class="form-control border">
                                        </p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                 <div class="col-sm-4 mb-1">
                                   ...
                                   <div class="row">
                                       ...
                                       <div class="col-sm-12">
                                           <p class="text-muted mb-0">
                                               <textarea name="address"  class="form-control border">{{ $teacher->address }}</textarea>
                                           </p>
                                       </div>
                                   </div>
                                   <hr>
