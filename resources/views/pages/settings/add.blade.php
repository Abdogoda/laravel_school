    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" style="font-family: 'Cairo', sans-serif;" id="addModalLabel">{{__('trans.add_new_book')}}</h5>
            ...
            <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4 mb-3">
                            ...
                            <input type="text" value="{{old('title_ar')}}" name="title_ar" class="form-control border" id="title_ar" required>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-3">
                            <label for="title_en" class="mr-sm-2">{{__('trans.book_title_english')}}</label>
                            <input type="text" value="{{old('title_en')}}" name="title_en" class="form-control border" id="title_en" required>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-3">
                            <label for="file" class="mr-sm-2">{{__('trans.file')}}</label>
                            <input type="file" value="{{old('file')}}" name="file" class="form-control border" id="file" accept="application/pdf" required>
                        </div>
                        <div class="col-md-6 col-lg-4 mb-3">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success">{{__('trans.add_new_book')}}</button>
                </div>
            </form>
        </div>
    </div>
