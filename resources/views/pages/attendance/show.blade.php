...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4>{{__('trans.attendance_list')}}</h4>
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                ...
                <li class="breadcrumb-item"><a href="{{route('attendance.index')}}" class="default-color">{{__('trans.attendance_list')}}</a></li>
                <li class="breadcrumb-item active">{{__('trans.attendance_list')}}</li>
            </ol>
        </div>
    </div>
</div>
